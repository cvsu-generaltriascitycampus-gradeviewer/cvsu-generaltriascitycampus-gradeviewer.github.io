...
if(isset($_POST['submit'])){
  ...
  $dateCreated = date("Y-m-d");
     ...
     $ret=mysqli_query($con,"update tbldepartment set departmentName='$departmentName', programId='$programId' where Id='$_SESSION[editId]'");
            ...
            <div class="animated fadeIn">
                                       ...
                                       <div class="<?php echo $alertStyle;?>" role="alert"><?php echo $statusMsg;?></div>
                                        <form method="Post" action="">
                                            <div class="row">
                                                ...
                                                if($count > 0){                       
                                                    echo ' <select required name="programId" class="custom-select form-control">';
                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">DEPARTMENT</h2></strong>
                            </div>
                            <div class="card-body">
                            ...
                            <?php
        $ret=mysqli_query($con,"SELECT tbldepartment.Id,tbldepartment.departmentName,tbldepartment.dateCreated, tblprograms.ProgramName
        from tbldepartment 
        INNER JOIN tblprograms ON tblprograms.Id = tbldepartment.programId");
        $cnt=1;
