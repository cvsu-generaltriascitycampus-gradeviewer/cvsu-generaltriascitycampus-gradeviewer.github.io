...
$programId=$_POST['programId'];
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($con,"insert into tblstudent(firstName,lastName,middleName,studentId,password,yearId,programId,departmentId,sessionId,dateCreated) value('$firstname','$lastname','$middleName','$studentId','cvsugentri','$yearId','$programId','$departmentId','$sessionId','$dateCreated')");
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="middleName" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Middle Name">
                                                    </div>
                                                </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="studentId" type="text" class="form-control cc-exp" value="" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Student ID">
                                                    </div>
                                                </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                         ...
                                         <div class="row">
                                             ...
                                             <p><small><i>Note: By default student's password is set to "<b>cvsugentri</b>"</i></small></p>
