    ...
    $ret=mysqli_fetch_array($query);
     ...
     if($ret > 0){ //Check the coure Title
      ...
      $statusMsg="This Course already exist!";
        ...
        $query=mysqli_query($con,"insert into tblcourse(courseTitle,courseCode,courseUnit,programId,departmentId,yearId,semesterId,dateAdded) value('$courseTitle','$courseCode','$courseUnit','$programId','$departmentId','$yearId','$semesterId','$dateAdded')");
