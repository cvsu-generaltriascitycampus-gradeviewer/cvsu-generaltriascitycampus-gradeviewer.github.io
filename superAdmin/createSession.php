            ...
            <div class="animated fadeIn">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="sessionName" type="tel" class="form-control cc-exp" value="" placeholder="School Year">
                                                    </div>
                                                </div>
                                                ...
                                                <button type="submit" name="submit" class="btn btn-success">Add School Year</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">SCHOOL YEAR</h2></strong>
                            </div>
                            <div class="card-body">
