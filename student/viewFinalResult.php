...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        tblstudent.dateCreated,tblprograms.ProgramName,tbldepartment.departmentName,tblcgparesult.cgpa,tblcgparesult.UnitAverage,
        tblstudent.programId,tblstudent.departmentId
        from tblcgparesult
        INNER JOIN tblstudent ON tblstudent.studentId = tblcgparesult.studentId
        ...
        where tblcgparesult.studentId ='$studentId'");
        $cnt=1;
        while ($row=mysqli_fetch_array($ret)) {
        ?>
        <tr>
        <td bgcolor="#F9D342"><?php  echo $row['firstName'].' '.$row['lastName'].' '.$row['middleName'];?></td>
        <td bgcolor="#F9D342"><?php  echo $row['studentId'];?></td>
        <td bgcolor="#F9D342"><?php  echo $row['ProgramName'];?></td>
        <td bgcolor="#F9D342"><?php  echo $row['departmentName'];?></td>
        <td bgcolor="#F9D342"><?php  echo $row['cgpa'];?></td>
        <td bgcolor="#F9D342"><?php  echo $row['UnitAverage'];?></td>
        </tr>
        <?php 
        $cnt=$cnt+1;
        }?>
