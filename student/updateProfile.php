...
if(isset($_POST['submit'])){
  ...
  $ret=mysqli_query($con,"update tblstaff set firstName='$firstname', lastName='$lastname', middleName='$middleName', 
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="middleName" type="text" class="form-control cc-exp" value="<?php echo $rrow['middleName'];?>" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Middle Name">
                                                    </div>
                                                </div>
                                            <div class="col-6">
                                                <div class="form-group">
