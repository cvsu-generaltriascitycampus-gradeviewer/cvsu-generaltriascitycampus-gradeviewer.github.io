                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h3 align="center">GRADING CRITERIA</h3></strong><br>
                                <h4 align="center"><img src="CVSU_LOGO.png" alt="" style="width:30px;height:30px;"><b>CAVITE STATE UNIVERSITY -  GENERAL TRIAS CITY CAMPUS</h4>
                            </div>
                            <div class="card-body">
