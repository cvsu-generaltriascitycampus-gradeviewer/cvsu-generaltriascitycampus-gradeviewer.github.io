        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    <td><a href="viewSemesterResult.php?semesterId=1&studentId=<?php echo $row['studentId'];?>&yearId=<?php echo $row['yearId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a></td>
                    <td><a href="viewSemesterResult.php?semesterId=2&studentId=<?php echo $row['studentId'];?>&yearId=<?php echo $row['yearId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a></td>
