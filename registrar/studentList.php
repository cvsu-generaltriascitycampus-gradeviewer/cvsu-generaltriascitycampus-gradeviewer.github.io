        ...
        <div class="content">
            <div class="animated fadeIn">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong class="card-title"><h3 align="center">Select Student to Input Grade</h3></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    <td><a href="courseList.php?semesterId=1&studentId=<?php echo $row['studentId'];?>&yearId=<?php echo $row['yearId'];?>&programId=<?php echo $row['programId'];?>&departmentId=<?php echo $row['departmentId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="Edit Details"><i class="fa fa-eye fa-1x"></i> View Course</a></td>
                    <td><a href="courseList.php?semesterId=2&studentId=<?php echo $row['studentId'];?>&yearId=<?php echo $row['yearId'];?>&programId=<?php echo $row['programId'];?>&departmentId=<?php echo $row['departmentId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="Edit Details"><i class="fa fa-eye fa-1x"></i> View Course</a></td>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
                    }
